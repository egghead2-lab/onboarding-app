...
export default async function CandidatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Generate signed URLs for each document so they're downloadable
    ...
    <div className="p-8 max-w-3xl">
      ...
      <section>
        ...
        <form action={addTask} className="flex gap-2 mb-3">
          ...
          <input name="title" placeholder="Add a task..." required className="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          <input name="due_date" type="date" className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
