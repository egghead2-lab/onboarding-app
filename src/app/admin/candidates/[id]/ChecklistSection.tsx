  ...
  return (
    <>
      ...
      <div className="bg-white border border-gray-200 rounded-lg divide-y divide-gray-100">
        {/* Header */}
        <div className="grid items-center gap-3 px-4 py-1.5 bg-gray-50 rounded-t-lg" style={{ gridTemplateColumns: '1rem 1fr 5rem 10rem 7rem 6.5rem' }}>
          <div />
        ...
        {visible.map(item => {
          ...
          return (
            <div key={item.id} className="grid items-center gap-3 px-4 py-1.5" style={{ gridTemplateColumns: '1rem 1fr 5rem 10rem 7rem 6.5rem' }}>
              <button
                onClick={() => toggle(item)}
