...
export default function RequirementRow({ req, isFirst, isLast, moveAction, updateAction, deleteAction }: Props) {
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <div className="flex gap-1">
                <input name="due_offset_value" type="number" min="0" defaultValue={initVal}
                  placeholder="Days"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button type="button" onClick={() => setEditing(true)}
              className="text-xs text-gray-500 hover:text-blue-600">Edit</button>
